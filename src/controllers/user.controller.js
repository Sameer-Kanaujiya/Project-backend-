...
const updateAccountDetails = asyncHandler( async( req ,res) => {
   ...
   return res
   .status(200)
   .json(new ApiResponse (200 , usr , "Account details updated successfully") )
...
const updateUserAvatar = asyncHandler (async (req ,res) => {
    ...
    .status(200)
    .json(
        new ApiResponse(200 , user ,"Avtar image updted successfully")
    )
...
const updateUserCoverImage = asyncHandler (async (req ,res) => {
    ...
    .status(200)
    .json(
        new ApiResponse(200 , user ,"cover image updted successfully")
    )
